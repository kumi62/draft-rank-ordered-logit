...
generated quantities {
  ...
  draft_sim = draft_rng(theta, beta_heights, heights, beta_propsr, propsr, beta_overage, overage, selected, available, unavailable, teams, n_picks_made, n_picks_total, P_available, P_unavailable, P);
