...
functions{
 ...
 int[] draft_rng(vector theta, vector beta_heights, real[] heights, vector beta_propsr, real[] propsr, vector beta_overage, int[] overage, int[] selected, int[] available, int[] unavailable, int[] teams, int m, int M, int P_available, int P_unavailable, int P) {
...
generated quantities {
  ...
  int draft_sim[n_picks_total,n_picks_made+1];
  
  // Simulate the NHL draft
  draft_sim = draft_retrospective_rng(theta, beta_heights, heights, beta_propsr, propsr, beta_overage, overage, selected, available, unavailable, teams, n_picks_made, n_picks_total, P_available, P_unavailable, P);
