...
generated quantities {
  ...
  draft_sim = draft_start_rng(theta, beta_heights, heights, beta_propsr, propsr, beta_overage, overage, available, unavailable, teams, n_picks_total, P_available, P_unavailable, P);
